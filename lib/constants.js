...
const DEBUG_REJECTION_ENV = String(
...
export const FLIPPER_MAX_ITEM_CAPITAL = Number(
  process.env.FLIPPER_MAX_ITEM_CAPITAL || 300000,
);

export const MANUAL_SNIPE_ALERT_COOLDOWN_HOURS = Number(
  process.env.MANUAL_SNIPE_ALERT_COOLDOWN_HOURS || 12,
);
