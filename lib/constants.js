...
export const MIN_SIMPLE_BUY_BRAIN_SCORE = Number(process.env.MIN_SIMPLE_BUY_BRAIN_SCORE || 70);

export const MIN_SIMPLE_BUY_PROFIT_PERCENT = Number(process.env.MIN_SIMPLE_BUY_PROFIT_PERCENT || 5);

export const MIN_SIMPLE_BUY_VOLUME_RATIO = Number(process.env.MIN_SIMPLE_BUY_VOLUME_RATIO || 0.7);

export const MAX_SIMPLE_BUY_FAKE_SPREAD_RISK = Number(process.env.MAX_SIMPLE_BUY_FAKE_SPREAD_RISK || 30);

export const SEND_EMPTY_SUMMARY = String(process.env.SEND_EMPTY_SUMMARY || "true").toLowerCase() !== "false";
...
export const ENABLE_LOW_CONVICTION_CANDIDATES =
  String(process.env.ENABLE_LOW_CONVICTION_CANDIDATES || "true").toLowerCase() !== "false";
...
export const FLIPS_DEBUG_REJECTIONS =
  String(process.env.FLIPS_DEBUG_REJECTIONS || "true").toLowerCase() !== "false";
